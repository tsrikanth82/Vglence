Feature: Testing Developer Update API Happy Path
  ...
  Scenario Outline: Send a JSON request with <SecID> Creating Developer and validate response
    ...
    Examples:
      | SecID                   | MobNum     | AAdNum     | Name     | emailId        | regNo      | fName     | roleId | usrName | pwd          | StatusCode | key       | value   |
      | Valid fields for  | 1238987675 | 9876543210 | Srikanth | test@gmail.com | REG1234567 | MyCompany | 10     | user123 | password1234 | 200        | createdBy | VGLENCE |
